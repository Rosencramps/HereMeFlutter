...
class _LogInState extends State<LogIn> {
      ...
      try {
        ...
        if (user != null) {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => NavControllerState()));
        }
        setState(() {
          showSpinner = false;
        });
  ...
  _saveUserSharedPref() async {
    ...
    for (int i = 0; i < socialMediasReference.data.length; i++) {
      if (socialMediasReference.data.keys.elementAt(i).toString() ==
          'username') {
        print('username ${socialMediasReference.data.values.elementAt(i)
            .toString()}');
        await prefs.setString('username',
            socialMediasReference.data.values.elementAt(i).toString());
      } else if (socialMediasReference.data.keys.elementAt(i).toString() ==
          'profileImageUrl') {
        print('photo url ${socialMediasReference.data.values.elementAt(i)
            .toString()}');
