...
class _PhotoAddState extends State<PhotoAdd> {
  ...
  Widget build(BuildContext context) {
    ...
    final polaroidPic = GestureDetector(
      onTap: () => _bottomActionSheet(context),
      child: Image.asset(
  ...
  _openPhotoLibrary() async {
    await ImagePicker.pickImage(source: ImageSource.gallery).then((profilePic) {
  ...
  _openCamera() async {
    await ImagePicker.pickImage(source: ImageSource.camera).then((profilePic) {
      if (profilePic != null) {
        _cropImage(profilePic);
        setState(() {
          showSpinner = false;
  ...
  void _bottomActionSheet(context) {
